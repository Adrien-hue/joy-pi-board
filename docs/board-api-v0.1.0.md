...
| [overview-stale.json](examples/overview-stale.json) | Failure at age 12 s with last snapshot retained; age header 12000 |
| [overview-expired.json](examples/overview-expired.json) | Failure at age 30.001 s; snapshot hidden; age header 30001 |
