...
| JPB-025 | Historic S00/S01 closure evidence preserved; S02 preparation scope/diff review; S02-T12 future exact-source CI closure, no S03/S04 execution | Documentary foundation, S00, S01, S02 preparation |
...
Authority: [Sprint 02](sprint-02.md), **PREPARED, NOT EXECUTED**. Every row is **NOT RUN**; criteria describe future assertions, not results. P-02/P-04/P-05 must be ratified before their dependent tests become implementation acceptance gates. The existing B IDs keep their product meaning; S02-Txx refine subsets, never replace B-10/B-11 or physical acceptance. P-06 measurement protocols remain proposed.
