...
| JPB-025 | Historic S00/S01 closure evidence preserved; S02 implementation scope/diff review and local evidence; S02-T12 exact-source hosted CI pending, no S03/S04 execution | Documentary foundation, S00, S01, S02 |
...
Before closure, produce the S02 local ledger and verify a new remote run with successful foundation/race jobs (or documented equivalent coverage), run attempt, event, tested SHA, actual image/tools and artifacts. No S00/S01 result is relabeled S02. B-10/B-11, target-browser execution, mobile/visual acceptance, Debian/systemd and physical C gates remain NOT RUN. P-06's performance definitions must be ratified before the corresponding measurements, not by preparing this matrix.

## S02 local execution trace

All rows below refer to the explicit dirty-source fingerprint and local results in [S02 evidence](s02-evidence.md), not historical hosted runs. Planned oracle rows above are specifications, while this table is the execution map. Full A/B/C acceptance remains incomplete.

| Matrix / requirements / gate subset | Implemented assertion sources | Local status / remaining scope |
|---|---|---|
| S02-T01; JPB-006/007/023; A-05 | config.TestConfiguration; main.TestSafeStartupExitCodes, TestStartupAndShutdownWithHealthAbsent, existing help/invalid-argument tests | PASS. Actual Pi readiness remains C-01/C-04 NOT RUN. |
| S02-T02/T03; JPB-008/012/014/016; B-05/B-06 | health.TestTransportPolicy, TestBodySizeBoundary, TestCountedBodyLimitAndEarlyTransportTimeout, TestWireFailuresAndNoReplay, TestSingleAddressProxyAndRedirect; overview.TestDeadlinePriorityAndImmutableViews; HTTP corpus | PASS: statuses, MIME/encoding/trailers, framing/header/body bounds, exact cutoff and S01 classifications. |
| S02-T04; JPB-008/020; B-06/A-05 | overview.TestRealDeadlineHeadersBodyAndProgress; health.TestCancellationAndRefusal; fake timer tests | PASS. Measured durations identify workstation/network harness; no Pi percentile claim. |
| S02-T05; JPB-009/010/013; B-01 envelope/B-07 | overview.TestStateTimeAndReplacement, TestClockRegressionAndShutdownRace | PASS: all five reasons, never-success/restart, full/partial replacement, recovery, exact boundaries and wall jumps. |
